...
const NewsList=Vue.component('news-list',{
    ...
    `<div class = "newsatlarge">
        ...
        <h2>News</h2>
        <div class="news">
            <ul class="news__list" v-bind:style="news_list">
                <li v-for="article in articles" class="news__item" v-bind:style="news_item">{{ article.title }} {{article.description}} <img v-bind:src= "article.urlToImage"/></li>
            </ul>
        </div>
    </div> 
